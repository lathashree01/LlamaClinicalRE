...
"""
 ...
 Code adapted from https://github.com/ymcui/Chinese-LLaMA-Alpaca/tree/main

 Changes:
    1. Added code to load LLaMA model as LlamaForCausalLM
"""
import logging
import numpy as np
import math
...
# os.environ["WANDB_PROJECT"]="mimic3-pretraining-final"
...
print("Running on devices: ", torch.cuda.device_count())
...
def main():
    ...
    ### Added code to load LLaMA model, Author: Lathashree
    ...
    if training_args.do_train:
        ...
        trainer.save_state()
        # with open("metrics_eval.pickle", "wb") as f:
    ...
    if training_args.do_eval:
        ...
        # wandb.log({"perplexity": perplexity, "step": ppl_step})
